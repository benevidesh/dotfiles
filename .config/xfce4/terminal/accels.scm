...
(gtk_accel_path "<Actions>/terminal-window/set-title-color" "<Alt>c")
...
(gtk_accel_path "<Actions>/terminal-window/open-folder" "<Primary><Shift>F3")
...
(gtk_accel_path "<Actions>/terminal-window/set-title" "<Alt>n")
